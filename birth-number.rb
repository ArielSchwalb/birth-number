...
#1. Ask the user for thier birthdate.
...
#5. Write an if statement. If the number is greater than 9, reduce again by following step 4. Otherwise, you are all set for the next step.
